...
Revision ID: 4fad27d28d84
Revises: 4909d4925499
Create Date: 2026-02-17 17:02:50.350902
...
revision: str = '4fad27d28d84'
down_revision: Union[str, Sequence[str], None] = '4909d4925499'
...
def upgrade() -> None:
    ...
    sa.CheckConstraint("status IN ('PENDING','ACCEPTED','REJECTED','WITHDRAWN')", name='ck_project_applications_status'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'user_id', name='uq_project_applications_project_user')
    )
